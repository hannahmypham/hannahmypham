...
|---|---|---|---|
| 📄 **[PeerMind](https://github.com/hannahmypham/PeerMind_AI-powered-meta-review)** | Fine-tuned transformer models to generate meta-reviews and predict ML paper acceptance | Python · HuggingFace · LoRA/PEFT | 84.8% decision accuracy |
...
![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54) ![R](https://img.shields.io/badge/r-%23276DC3.svg?style=for-the-badge&logo=r&logoColor=white) ![SQL](https://img.shields.io/badge/SQL-4479A1?style=for-the-badge&logo=mysql&logoColor=white)
...
**ML Research Assistant — Cognitive Development Laboratory, UCSD** *(Apr 2026 – Present)*
> Built an audio source separation pipeline using PyTorch and SAM Audio to isolate infant and caregiver speech, enabling automated annotation workflows for early language development research.
